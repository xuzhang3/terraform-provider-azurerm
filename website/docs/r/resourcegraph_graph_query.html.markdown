...
layout: "azurerm"
page_title: "Azure Resource Manager: azurerm_resourcegraph_graph_query"
description: |-
  Manages a Resource Graph.
---

# azurerm_resourcegraph_graph_query
...
```hcl
resource "azurerm_resourcegraph_graph_query" "example" {
  name                = "example"
...
* `namne` - (Required) The name of the Graph Query resource. Changing this forces a new Resource Graph to be created.
...
```shell
terraform import azurerm_resourcegraph_graph_query.example /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/group1/providers/Microsoft.ResourceGraph/queries/resource1
```
